...
人工去敏與原始 key scan，provider unit/E2E mock 直接消費 golden frames，
完整 release gate 隨後全數重跑通過。
...
總估 9–12 個工作天。階段 0＋1 的完成條件「兩個最新模型真實可用＋隱私合規」已於 2026-07-30 live probe 與去敏 gate 達成。階段 2 完成＝即時性有量測背書；階段 3–4 完成才談 production ready。
